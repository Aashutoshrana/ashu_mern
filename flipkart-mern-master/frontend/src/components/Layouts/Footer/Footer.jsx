          ...
          <footer className="mt-20 w-full py-1 sm:py-4 px-4 sm:px-12 bg-primary-darkBlue text-white text-xs border-b border-gray-600 flex flex-col sm:flex-row overflow-hidden">
            ...
            <div className="w-full sm:w-5/12 my-6 mx-5 sm:mx-0 flex flex-col sm:flex-row gap-2 sm:gap-0 justify-between">
              <div className="w-full sm:w-1/2">
                <h2 className="text-primary-grey">Mail Us:"ashutoshrana99014@gmail.com"</h2>
                <p className="mt-2 leading-5"><br />
                  Noida sec-15 &<br />
                 B-67,<br />
                  B-67,Gatuam Budha Nagar<br />
                  India
                </p>
              </div>
              ...
              <div className="w-full sm:w-1/2">
                ...
                <p className="mt-2 leading-5">Rana Internet Private Limited,<br />
                  B-67 sector 15 Noida &<br />
                  Clove Embassy Tech Village,<br />
                  Outer Ring Road, Devarabeesanahalli Village,<br />
               Noida, 201301,<br />
                  Uttar Pradesh, India <br />
                  CIN : Br20001<br />
                  Telephone: <a className="text-primary-blue" href="tel:18002029898">+91 -9135913541</a>
                </p>
              </div>
            </div>
